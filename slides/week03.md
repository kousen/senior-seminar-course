---
theme: seriph
title: "Week 3: Define the Journey"
colorSchema: light
...
<div class="callout"><strong>Say what landed.</strong> One specific moment that worked, and why.</div>
<div class="callout amber mt-4"><strong>Say one thing to change.</strong> One, not five. The most useful one.</div>
<div class="callout mt-4"><strong>Use the vocabulary.</strong> Where was the call to adventure? Did it end higher than it started? Who was the hero?</div>
</div>
...
<img src="./images/tacking.svg" style="max-height: 340px" alt="A zigzag sailing course toward a destination against the wind, each leg labeled what is or what could be" />
</div>
...
<div class="grid gap-6 items-center" style="grid-template-columns: 3fr 2fr">
<div>
<img src="./images/character-arc.svg" style="width: 100%; max-height: 330px" alt="Two pages of a screenplay with an arc between them, labeled who they are walking in and who they are walking out" />
</div>
<div class="text-sm">
...
<div class="flex flex-col justify-center h-full pl-6 text-sm">
<div class="callout">
<strong>Topic:</strong> "Traffic camera analytics for the City of Hartford."
</div>
<div class="text-center text-2xl my-1 opacity-50">↓</div>
...
<div class="grid grid-cols-2 gap-6 mt-2" style="max-width: 860px; margin: 0 auto">
<div class="callout">
...
<div class="mt-6 text-base" style="max-width: 860px; margin-left: auto; margin-right: auto">

"We are losing our competitive edge" has nothing at stake. "If we do not get it back, your jobs are at risk" does.

</div>

<div class="callout mt-6" style="max-width: 860px; margin-left: auto; margin-right: auto">
...
<div class="callout"><strong>Comfort zone.</strong> How far outside it are you asking them to go?</div>
<div class="callout amber"><strong>Fear.</strong> What keeps them up at night? Which fears are valid, which need dispelling?</div>
<div class="callout"><strong>Vulnerabilities.</strong> Recent errors, weaknesses, changes they are still absorbing.</div>
<div class="callout amber"><strong>Misunderstanding.</strong> What could they get wrong about the message or its implications?</div>
<div class="callout"><strong>Obstacles.</strong> What practical or mental barrier stops them acting even if they agree?</div>
<div class="callout amber"><strong>Politics.</strong> Who has influence over them? Does your idea shift power?</div>
</div>
...
<div class="flex items-center justify-center h-full pl-4">
<img src="./images/rewards.svg" style="max-height: 400px" alt="A staircase of seven kinds of reward from basic needs to destiny" />
</div>
...
<div class="grid grid-cols-3 gap-6 mt-4" style="max-width: 900px; margin: 0 auto">
<div class="callout text-center"><div class="text-4xl mb-2">1</div>from the sheet</div>
<div class="callout amber text-center"><div class="text-4xl mb-2">2</div>from the sheet</div>
<div class="callout text-center"><div class="text-4xl mb-2">3</div>from the sheet</div>
</div>

<div class="text-base mt-8" style="max-width: 900px; margin-left: auto; margin-right: auto">

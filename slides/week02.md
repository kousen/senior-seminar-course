---
theme: seriph
title: "Week 2: Myths, Movies, and the Hero"
colorSchema: light
...
<img src="./images/spectrum.svg" class="mx-auto" style="max-height: 260px" alt="A spectrum from report to story with the talk in the middle" />
...
<img src="./images/slideument.svg" style="max-height: 400px" alt="A projected slide packed with text, and a row of heads reading it" />
</div>
...
<div class="callout"><strong>Act 1.</strong> Set up. Who the hero is, what they want, why they cannot have it yet.</div>
<div class="callout amber"><strong>Turning point.</strong> Something happens that changes the direction.</div>
<div class="callout"><strong>Act 2.</strong> Confrontation. Obstacles, one after another. Twice as long as the others.</div>
<div class="callout amber"><strong>Turning point.</strong> The last piece falls into place.</div>
<div class="callout"><strong>Act 3.</strong> Resolution. Did they get it?</div>
</div>
...
<div class="flex items-center justify-center h-full">
<img src="./images/hero-journey.svg" style="max-height: 460px" alt="The twelve-step hero's journey drawn as a wheel" />
</div>
...
<div class="flex items-center justify-center h-full pl-4">
<img src="./images/sparkline.svg" style="max-height: 300px" alt="A sparkline moving between what is and what could be" />
</div>
...
<img src="./images/presentation-form.svg" class="mx-auto" style="width: 92%; max-height: 300px" alt="The presentation form, annotated" />

<div class="grid grid-cols-5 gap-2 text-xs mt-2">
<div class="callout"><strong>Beginning.</strong> Their world, stated so they nod. Ten percent at most.</div>
<div class="callout amber"><strong>Call to adventure.</strong> The gap, clearly and once. The inciting incident.</div>
<div class="callout"><strong>Middle.</strong> Back and forth. Contrast in content, emotion, delivery.</div>
<div class="callout amber"><strong>Call to action.</strong> Exactly what to do. Doers, suppliers, influencers, innovators.</div>
<div class="callout"><strong>New bliss.</strong> End higher than you started. Last words stick.</div>
</div>
...
<div class="flex items-center justify-center h-full pl-4">
<img src="./images/queue.svg" style="max-height: 300px" alt="A line of individuals waiting to talk to the presenter" />
</div>
...
<div class="flex items-center justify-center h-full pl-4">
<img src="./images/segments.svg" style="max-height: 380px" alt="An audience drawn as four clusters of dots" />
</div>
...
<div class="flex items-center justify-center h-full pl-4">
<img src="./images/december-audience.svg" style="max-height: 400px" alt="Three audience groups: faculty, the Travelers representative, classmates" />
</div>
...
<div class="flex items-center justify-center h-full pl-4">
<img src="./images/overlap.svg" style="max-height: 380px" alt="Two overlapping circles: the audience and the mentor, with common ground in the middle" />
</div>
